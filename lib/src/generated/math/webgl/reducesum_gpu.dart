...
/// ==============================================================================
@JS()
class ReduceSumProgram implements GPGPUProgram {
  // @Ignore
  ReduceSumProgram.fakeConstructor$();
  external num get aSize;
  external set aSize(num v);
  ...
  external factory ReduceSumProgram(num aSize);
}
