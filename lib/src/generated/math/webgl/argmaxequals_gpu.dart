...
/// ==============================================================================
@JS()
class ArgMaxEqualsProgram implements GPGPUProgram {
  // @Ignore
  ArgMaxEqualsProgram.fakeConstructor$();
  ...
  external factory ArgMaxEqualsProgram(num aSize, num bSize);
}
