...
/// ==============================================================================
@JS()
class AddScaledMatProgram implements GPGPUProgram {
  // @Ignore
  AddScaledMatProgram.fakeConstructor$();
  ...
  external factory AddScaledMatProgram(List<num> aShape, List<num> bShape);
}
