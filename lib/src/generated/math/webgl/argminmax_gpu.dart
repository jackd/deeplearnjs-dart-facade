...
/// ==============================================================================
@JS()
external String getArgMinMaxSnippet(
    String /*'min'|'max'*/ op, String texName, num size);
...
class ArgMinMaxProgram implements GPGPUProgram {
  ...
  external factory ArgMinMaxProgram(num aSize, String /*'min'|'max'*/ opType);
}
