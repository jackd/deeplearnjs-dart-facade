...
abstract class Operation {
  // @Ignore
  Operation.fakeConstructor$();
  external void feedForward(NDArrayMath math, TensorArrayMap inferenceArrays);
  external void backProp(NDArrayMath math, TensorArrayMap inferenceArrays,
