...
/// @hidden
@JS()
class Concat3D extends Operation {
  // @Ignore
  Concat3D.fakeConstructor$() : super.fakeConstructor$();
  ...
  external factory Concat3D(
      Tensor x1Tensor, Tensor x2Tensor, num axis, Tensor yTensor);
